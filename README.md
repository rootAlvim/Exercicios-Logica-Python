> ⚠️ Este repositório foi clonado do original [isquicha/exercicios-python](https://github.com/isquicha/exercicios-python), porém **todos os exercícios foram removidos** e serão **resolvidos por mim do zero** como forma de estudo pessoal e prática de lógica de programação em Python.
>
> O objetivo é **refazer todos os exercícios com minha própria lógica e aprendizado**, podendo eventualmente divergir das soluções do repositório original.
